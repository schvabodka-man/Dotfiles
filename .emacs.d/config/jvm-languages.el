...
(use-package groovy-imports
  ...
  (evil-define-key 'normal groovy-mode-map (kbd "i") 'groovy-imports-add-import)
  (evil-define-key 'normal groovy-mode-map  (kbd "I") 'groovy-imports-add-import-dwim)
  (evil-define-key 'normal groovy-mode-map  (kbd "C-i") 'groovy-imports-scan-file)
...
(use-package inf-groovy
  ...
  (evil-define-key 'normal inferior-groovy-mode-map  (kbd "<f1>") 'switch-to-groovy)
  (evil-define-key 'normal inferior-groovy-mode-map  (kbd "<S-f1>") 'run-groovy)
  (evil-define-key 'normal inferior-groovy-mode-map  (kbd "e") 'groovy-send-region)
  (evil-define-key 'normal inferior-groovy-mode-map  (kbd "E") 'groovy-send-region-and-go)
  (evil-define-key 'normal inferior-groovy-mode-map  (kbd "i") 'groovy-imports-add-import)
  (evil-define-key 'normal inferior-groovy-mode-map  (kbd "I") 'groovy-imports-add-import-dwim)
  (evil-define-key 'normal inferior-groovy-mode-map  (kbd "C-i") 'groovy-imports-scan-file)
...
(add-hook 'nxml-mode-hook (lambda ()
							(when (string= (file-name-base buffer-file-name))
							  (maven-pom-mode))))
(evil-define-key 'normal maven-pom-mode-map (kbd "i") #'maven-pom-add-dependency)
(evil-define-key 'normal maven-pom-mode-map (kbd "I") #'maven-pom-insert-dependency-xml)
