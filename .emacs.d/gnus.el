...
(setq gnus-group-mode-hook
      '(lambda ()
		 ...
		 (local-set-key (kbd "C-S-m") #'gnus-group-mark-buffer)
		 (local-set-key (kbd "U") #'gnus-group-unmark-all-groups)
		 (local-set-key (kbd "C-m") #'gnus-group-mark-regexp)
...
(setq gnus-summary-mode-hook 
      '(lambda ()
		 ...
		 (local-set-key (kbd "C-r") #'gnus-summary-rescan-group)
		 ...
		 (local-set-key (kbd "R") #'gnus-summary-catchup)
