...
;;just hardcoding this shit in functions, instead of aliases
...
(defun books-completed ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/Org/Wiki/Tracking/Books.org")))
(defun movies-completed ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/Org/Wiki/Tracking/Movies.org")))
(defun anime-completed ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/Org/Wiki/Tracking/Anime.org")))
(defun cartoons-completed ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/Org/Wiki/Tracking/Cartoons.org")))
...
(defun games-todo ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/todo/games.txt"))
  (todotxt-mode))
(defun movies-todo ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/todo/movies.txt"))
  (todotxt-mode))
(defun books-todo ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/todo/books.txt"))
  (todotxt-mode))
(defun anime-todo ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/todo/anime.txt"))
  (todotxt-mode))
(defun cartoons-todo ()
  (interactive)
  (find-file (expand-file-name "/home/user/Dropbox/todo/cartoons.txt"))
  (todotxt-mode))
